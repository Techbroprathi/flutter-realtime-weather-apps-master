...
import 'package:flutter_upwork_project/Animal.dart';
import 'package:flutter_upwork_project/model%20data/weather_data.dart';

import 'package:flutter_upwork_project/screens/blink.dart';
import 'package:flutter_upwork_project/screens/zoomearth.dart';
import 'package:flutter_upwork_project/screens/details_page.dart';
import 'package:flutter_upwork_project/screens/shop_screen.dart';
...
import 'package:flutter_upwork_project/Home_page.dart';
                      ...
                      children: [
                       ...
                       // Icon(CupertinoIcons.home, color: Colors.white,),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Icon(CupertinoIcons.location_solid, color: Colors.black12),
                              GestureDetector(
                                onTap: () {
                                  searchbar = true;
                                  setState(() {});
...
void onSetting(BuildContext context) {
  showModalBottomSheet(
    ...
    return Column(
        ...
        children: <Widget>[
    ListTile(
    title: Text('Soil Report'.trim()),
  onTap: () {
  Navigator.pop(context);
  Navigator.push(context, CupertinoPageRoute(builder: (_) => Blink()));
  },
  ),
          Divider(height: 0.0),
          ListTile(
            title: Text('Crop Guide'.trim()),
            onTap: () {
              Navigator.pop(context);
              Navigator.push(context, CupertinoPageRoute(builder: (_) => Crop()));
            },
          ),
          Divider(height: 0.0),
          ListTile(
            title: Text('Animal diseases'.trim()),
            onTap: () {
              Navigator.pop(context);
              Navigator.push(context, CupertinoPageRoute(builder: (_) => Animal()));
            },
          ),
          Divider(height: 0.0),
          ListTile(
            title: Text('Zoom Earth'.trim()),
            onTap: () {
              Navigator.pop(context);
              Navigator.push(context, CupertinoPageRoute(builder: (_) => Zoomearth()));
            },
          ),
